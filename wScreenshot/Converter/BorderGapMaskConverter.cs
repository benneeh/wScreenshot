...
namespace wScreenshot.Converter
{
    ...
    public class BorderGapMaskConverter : IMultiValueConverter
    {
        ...
        /// Convert a value.
        /// </summary>
        /// <param name="values">values as produced by source binding
        /// <param name="targetType">target type
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var borderLeft = (double)values[0];
            var borderTop = (double)values[1];
            var borderWidth = (double)values[2];
            var borderHeight = (double)values[3];
            ...
            colDef2.Width = new GridLength(borderWidth);
