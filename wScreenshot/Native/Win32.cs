...
namespace wScreenshot.Native
{
    public class Win32
    {
        ...
        public struct RECT
        {
            ...
            {
                get { return new Point(m_nLeft, m_nTop); }
            }
            ...
            public Rectangle Rectangle
            {
                get { return Rectangle.FromLTRB(m_nLeft, m_nTop, m_nRight, m_nBottom); }
            }
            ...
            public Rect Rect
            {
                get { return new Rect(m_nLeft, m_nTop, m_nRight, m_nBottom); }
            }
            ...
            {
                return m_nLeft ^ ((m_nTop << 13) | (m_nTop >> 0x13))
                       ^ ((Width << 0x1a) | (Width >> 6))
